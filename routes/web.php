...
$latestServiceVideos = function () {
    return ProjectVideo::query()
        ->where('is_featured', true)
        ->latest()
        ->get()
        ->groupBy(function (ProjectVideo $video) {
            return $video->feature_category ?: $video->category;
        })
        ->map(function ($videos) {
            return $videos->first();
        });
...
Route::get('/services', function () use ($latestServiceVideos) {
    return view('pages.services', ['latestVideos' => $latestServiceVideos()]);
});

Route::get('/what-we-do/services', function () use ($latestServiceVideos) {
    return view('pages.services', ['latestVideos' => $latestServiceVideos()]);
})->name('services');

// Legacy routes redirect to unified services page
Route::get('/services/commercial-ads', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/ai-commercial-ads', function () { return redirect('/what-we-do/services'); });

Route::get('/services/product-ads', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/ai-product-ads', function () { return redirect('/what-we-do/services'); });

Route::get('/services/storytelling-drama', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/ai-storytelling-drama', function () { return redirect('/what-we-do/services'); });

Route::get('/services/movie-trailers', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/ai-movie-trailers', function () { return redirect('/what-we-do/services'); });

Route::get('/services/ugc-style-ai-videos', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/ugc-style-ai-videos', function () { return redirect('/what-we-do/services'); });

Route::get('/services/explainer-videos', function () { return redirect('/what-we-do/services'); });
Route::get('/what-we-do/explainer-videos', function () { return redirect('/what-we-do/services'); });
