...
<body style="margin:0; padding:32px 16px; background:#f3f3f1; font-family:Arial, Helvetica, sans-serif; color:#111827;">
    <div style="max-width:640px; margin:0 auto; background:#ffffff; border:1px solid #e5e7eb; border-radius:18px; overflow:hidden; box-shadow:0 18px 42px rgba(17, 24, 39, 0.08);">
        <div style="background:#000; padding:30px 24px 24px; text-align:center;">
            <img src="{{ asset('logo.png') }}" alt="Aizap Creatives" style="display:block; margin:0 auto 12px; width:140px; max-width:100%; height:auto;">
            <div style="font-size:12px; letter-spacing:3px; color:#FFD400; font-weight:700; text-transform:uppercase;">Aizap Creatives</div>
        </div>
        ...
        <div style="padding:34px 32px 28px; background:#ffffff;">
            ...
            <div style="margin:20px 0 24px; text-align:center;">
                <a href="{{ $resetUrl }}" style="display:inline-block; background:#111827; color:#FFD400; font-size:16px; font-weight:800; text-decoration:none; padding:14px 30px; border-radius:12px;">Reset Password</a>
            </div>
