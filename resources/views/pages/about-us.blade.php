...
<body class="about-us-page">
    ...
    <main id="app-content">
        ...
        <section class="about-hero-block" style="background-image: url('{{ asset('about-us.png') }}');">
            ...
            <div class="about-copy">
                ...
                <p>
                    At Aizap Creatives, we combine the power of artificial intelligence with human imagination to create content that connects, inspires, and delivers real results.
                </p>
