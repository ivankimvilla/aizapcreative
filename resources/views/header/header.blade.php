...
<header class="site-header">
    ...
    <nav class="site-header__nav" id="siteNav">
        ...
        <a href="{{ url('/book-a-call') }}" class="site-header__cta site-header__cta--mobile {{ request()->is('book-a-call') ? 'site-header__cta--active' : '' }}">
    ...
    <a href="{{ url('/book-a-call') }}" class="site-header__cta site-header__cta--desktop {{ request()->is('book-a-call') ? 'site-header__cta--active' : '' }}">
        <span class="site-header__cta-icon">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M5 12H19M19 12L13 6M19 12L13 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
